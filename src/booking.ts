...
import { VoyageData, VoyageurData } from "./interfaces";
...
let booking: string | null = '';

let travelerData: VoyageurData;
let travelingData: VoyageData;
...
function getBookingData() {
    ...
    if (user && booking) {
        travelerData = JSON.parse(user) as VoyageurData;
        travelingData = JSON.parse(booking) as VoyageData;
        displayBookingData();
    }
    else {
